...
namespace MerceriaGit.Controllers
{
    public class PaqueteriasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Telefono,Correo,Direccion,Estado")] Paqueterias paqueterias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Telefono,Correo,Direccion,Estado")] Paqueterias paqueterias)
        {
            if (ModelState.IsValid)
            {
