...
namespace MerceriaGit.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Descripcion,Estado")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Descripcion,Estado")] TipoUsuario tipoUsuario)
        {
            if (ModelState.IsValid)
            {
