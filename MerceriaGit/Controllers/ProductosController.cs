...
namespace MerceriaGit.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Id_Subcategoria,Nombre,Descripcion,Imagen,Precio_Compra,Precio_Venta,Existencia,Estado")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Id_Subcategoria,Nombre,Descripcion,Imagen,Precio_Compra,Precio_Venta,Existencia,Estado")] Productos productos)
        {
            if (ModelState.IsValid)
            {
